...
namespace TechSchool.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseSqlServer(Configuration["ConnectionStrings:TechSchoolConnection"]));
            ...
            DataMapper.InitMapper(); // Ensure the map is created before it is used.
